...
document.writeln("Округлення суми в меньшу сторону: " + (Math.floor(priceSweetmeats) + Math.floor(priceIceCream) + Math.floor(pricePie)) + " грн" + "<br>" + "<br>" );
...
document.writeln("Сума товарів округлена до сотень: " + (Math.ceil((priceSweetmeats + priceIceCream + pricePie) / 100.0) * 100.0) + " грн" + "<br>" + "<br>" );
...
console.log(("Сума решти, при оплаті всіх товарів, якщо клієнт платить 500 грн: " + Math.abs((priceSweetmeats + priceIceCream + pricePie) - 500)) + " грн");
document.writeln("Сума решти, при оплаті всіх товарів, якщо клієнт платить 500 грн: " + Math.abs((priceSweetmeats + priceIceCream + pricePie)  - 500) + " грн" + "<br>" + "<br>")

//Виведіть середнє значення цін, округлене до другого знаку після коми:
console.log("Cереднє значення цін, округлене до другого знаку після коми:" + Number(
    Math.round((priceSweetmeats + priceIceCream + pricePie)) / 3
    ).toFixed(2)
)
